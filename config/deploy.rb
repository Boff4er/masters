...
set :branch,          "origin/test"
set :migrate_target,  :current
set :ssh_options,     { :forward_agent => true }
set :rails_env,       "production"
set :deploy_to,       "/var/www/admin/www/xn----7sbbpfar3bgrlnafl8l.xn--p1ai"
...
role :web,    "46.36.216.84"
role :app,    "46.36.216.84"
role :db,     "46.36.216.84", :primary => true
...
default_environment["PATH"]         = "/usr/local/rvm/gems/ruby-2.2.1/bin:/usr/local/rvm/gems/ruby-2.2.1@global/bin:/usr/local/rvm/rubies/ruby-2.2.1/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/rvm/bin"
...
namespace :deploy do
  ...
  task :restart, :except => { :no_release => true } do
    run "kill -s USR2 `cat /tmp/unicorn.buro.pid`"
  end
